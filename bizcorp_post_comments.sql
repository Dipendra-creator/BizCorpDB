...
CREATE TABLE `post_comments` (
  ...
  `post_comment_likes` bigint DEFAULT (0),
  `from_user` int DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  PRIMARY KEY (`PostCommentsId`),
  KEY `post` (`post`),
  KEY `from_user` (`from_user`),
  CONSTRAINT `post_comments_ibfk_1` FOREIGN KEY (`post`) REFERENCES `posts` (`PostId`),
  CONSTRAINT `post_comments_ibfk_2` FOREIGN KEY (`from_user`) REFERENCES `user` (`UserId`)
